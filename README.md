# St2-057 online drone environment，Enjoy！


# 0x01 build environment docker
...
# 0x02 build st2-057 vulnerability environment
```
...
![](./start.jpg)
# 0x05  Verify st2-057
docker target drone：http://www.canyouseeme.cc:8080/struts2-showcase/
...
#### Ps: ${(111+111)} Can be replaced with a previous poc, such as S2-032
...
```
# 0x06 Execute with an old version of the calculator or command
...
![](./struts-2.2.3.1.jpg)
Ps： The pit is a low version capable of playing the calculator, the high version can not
